...
/**
 * A game in which the list of played moves matters.
 * For example a Chess game ends if 50 moves are played without check nor captured piece.
 * 
...
public abstract class GameHistory<B extends IBoard<?, ?>, M extends IMove<B>, DM extends IDecisionMaker<? super B, M, ?>>
    ...
    /**
     * This method returns the move played at a given time (0 is the first move, 1 the second one, etc.).
     * Negative numbers can be used to get moves played recently (-1 is the last move, -2 the move before, etc.).
     * @param i a positive or negative number.
     ...
     * By default this method is already called by applyMove.
     * @param m
     */
